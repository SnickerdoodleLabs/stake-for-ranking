...
\usepackage{hyperref, graphicx, floatrow, tikz, float, algpseudocode, algorithm, smartdiagram, amsmath} % adds linking on the doc
\usetikzlibrary{chains,tree,shapes,arrows,backgrounds,fit}
